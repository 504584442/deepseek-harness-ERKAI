...
export const zh = {
  ...
  discoveryNav: '插件发现',
  discoveryTitle: '插件发现',
  discoveryIntro: '每天发现值得安装的 TM Agent 插件',
  marketTitle: '天幕插件市场',
  marketHint: '浏览天幕插件市场的完整插件库与榜单',
  ...
  installReleaseGated: '安装与卸载只在 TM Agent 中可用。',
  ...
  applicationIntro: '发现并启动由天幕桌面端集成的完整 AI 应用。应用拥有独立界面、数据与运行流程。',
  applicationSources: '应用来源',
  applicationOfficial: '天幕官方',
  applicationOfficialHint: '由天幕桌面端开发团队内置维护的完整应用，不代表 DeepSeek 官方。',
  ...
  presetIntro: '发现天幕官方工作流与社区 Agent Preset，一键安装后用于新会话',
  ...
  presetFufanOfficialTitle: '天幕官方',
  presetFufanOfficialHint: '由天幕桌面端开发团队维护的七套内置工作流。',
  presetFufanOfficialBadge: '天幕官方',
  presetFufanOfficialPackage: '内置能力包 · 安装后可删除',
  presetFufanOfficialDisclaimer: '由天幕桌面端开发团队维护并随应用发布，不代表 DeepSeek 官方。',
  ...
  presetRuntimeConfirmDetail: '将从固定软件源下载已锁定版本，安装到 TM Agent 的专属本机目录；不会修改系统级软件，耗时取决于网络。',
...
export const en = {
  ...
  discoveryIntro: 'Find TM Agent plugins worth installing every day.',
  marketTitle: 'Tianmu Plugin Market',
  marketHint: 'Browse the full Tianmu plugin library and rankings',
  ...
  installReleaseGated: 'Install and uninstall are available only in TM Agent.',
  ...
  applicationIntro: 'Discover and launch complete AI applications integrated by Tianmu Desktop, each with its own interface, data, and runtime workflow.',
  applicationSources: 'Application sources',
  applicationOfficial: 'Tianmu Official',
  applicationOfficialHint: 'Complete applications maintained and shipped by the Tianmu Desktop team; not official DeepSeek content.',
  ...
  presetIntro: 'Discover Tianmu-maintained workflows and community Agent presets, then install them for new sessions.',
  ...
  presetFufanOfficialTitle: 'Tianmu Official',
  presetFufanOfficialHint: 'Seven built-in workflows maintained by the Tianmu Desktop team.',
  presetFufanOfficialBadge: 'Tianmu Official',
  presetFufanOfficialPackage: 'Built-in capability pack · removable after installation',
  presetFufanOfficialDisclaimer: 'Maintained and shipped by the Tianmu Desktop team; not official DeepSeek content.',
